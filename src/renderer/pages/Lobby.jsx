...
import React, { useEffect, useState, useRef, useCallback } from 'react';import { useNavigate } from 'react-router-dom';
...
function PlayerCard({ role, label, active, status }) {
  return (
    ...
    `}>
      ...
      <div className={`w-2 h-2 rounded-full ${active ? 'bg-green-400 animate-pulse' : 'bg-white/20'}`} />    </div>
  );
}
